...
```
mysql -h 172.16.4.99 -P 9125 -u root -Dtest --prompt="tidb> "
...
```
mysql -h 172.16.4.99 -P 9125 -u root -Dtpch_100_multi_key --prompt="tidb> "
...
* Optimized
```
mysql -h 172.16.4.99 -P 9125 -u root -Dtpch_100_multi_key --prompt="tidb(opt.)> "
